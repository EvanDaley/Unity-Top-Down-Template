...
namespace Rito.RadialMenu_v3.Editor
{
    ...
    public class RadialMenuEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty _applyRange;
        ...
        private SerializedProperty _appearanceLocation;
        ...
        private void OnEnable()
        {
            ...
            try
            {
                ...
                _applyRange = serializedObject.FindProperty(nameof(_applyRange));
                ...
                _appearanceLocation = serializedObject.FindProperty(nameof(_appearanceLocation));
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Slider(_appearanceDuration, 0.01f, 1f, "Appearance Duration");
            EditorGUILayout.Slider(_disppearanceDuration, 0.01f, 1f, "Disappearance Duration");
            ...
            EditorGUILayout.Space(12f);
            ColorLabelField("Location Options", LightCyan);
            EditorGUILayout.PropertyField(_appearanceLocation);
